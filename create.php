...
<div class="d-flex">
       ...
       <div class="container-principal">
           <form action="config/insert.php" method="post">
                ...
                <div class="d-flex">
                    <input type="text" name="phone" class="input-text" autocomplete="off" placeholder="(DD) - 0 0000-0000 ">
                </div>
                <div class="d-flex">
                    <input type="text" name="address" class="input-text" autocomplete="off" placeholder="Address">
                </div>
